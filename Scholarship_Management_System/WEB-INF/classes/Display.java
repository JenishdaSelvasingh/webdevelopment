...
public class Display extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            // pw.println("testing");
            trlistcontent = "<table id='trainlist' border='2' cellspacing='3' cellpadding='8'  background-color='#04AA6D' color='white' bordercolor='#9a00ff' align='center'><tr><th>Scholarship Id</th><th>Eligibility</th><th>Scholarship Name</th><th>Community</th><th>Income</th><th>Percentage of Mark</th></tr>";
            for(int i = 0; i < trlist.length; i++) {
                if(trlist[i][0] != null) {
                    trlistcontent += "<tr>";
