...
public class Display1 extends HttpServlet {
    public String[][] getStudents(String name, String contact) throws Exception {
        ...
        try {
            ...
            System.out.println("Hey I am after forname method in getStudents() - SearchStudent class");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            // pw.println("testing");
            trlistcontent = "<table id='trainlist' border='2' cellspacing='3' cellpadding='8'  background-color='#04AA6D' color='white' bordercolor='#9a00ff' align='center'><tr><th>Student Id</th><th>Email</th><th>Password</th><th>Student Name</th><th>Gender</th><th>City</th></tr>";
            for(int i = 0; i < trlist.length; i++) {
                if(trlist[i][0] != null) {
                    trlistcontent += "<tr>";
