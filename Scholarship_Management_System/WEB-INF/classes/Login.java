...
public class Login extends HttpServlet {
    public int loginUser(String email, String password) throws Exception{
        ...
        try {
            String s = String.format("select pwd from student where email = '%s'", email);
            ...
            if(rs.next()) {
                ...
                if(pwd.equals(password)) {
                    ...
                    if((email.equalsIgnoreCase("admin@gmail.com") && pwd.equalsIgnoreCase("admin"))|| (email.equalsIgnoreCase("schofficer@gmail.com") && pwd.equalsIgnoreCase("schofficer"))|| (email.equalsIgnoreCase("staff@gmail.com") && pwd.equalsIgnoreCase("staff"))) {
                        return 2;
                    }
                    return 1;
                }
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if(result == -1) {
                ...
                Cookie c1 = new Cookie("email", email);
                res.addCookie(c1);
                res.sendRedirect("officerpage.html");
            }
        }
        catch(Exception e) {
            System.out.println(e);
